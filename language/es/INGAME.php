...
$LNG['lm_repairdock'] = 'Muelle de reparación';
...
$LNG['gl_wreckfield_short'] = 'Cdn';
$LNG['gl_wreckfield'] = 'Campo de naufragios';
...
$LNG['fl_trade_no_resource_loaded'] = 'No has cargado ningún recurso.';
$LNG['fl_trade_to_many_resources_loaded'] = 'Sólo puedes vender un recurso.';
$LNG['fl_trade_same_resource'] = 'No puedes vender %s por %s.';
$LNG['fl_not_enough'] = 'No hay suficientes %s disponibles.';
...
$LNG['bd_wreck_count'] = 'Pecios en el campo de pecios';
$LNG['bd_repair_rate'] = 'Tasa de reparación';
...
$LNG['sys_notenough_money'] = 'En el planeta %s <a href="?page=buildings&amp;cp=%d&amp;re=0">[%d:%d:%d]</a> no tienes'
    . ' suficientes recursos para construir %s . <br>Ahora tienes %s de %s , %s de %s y %s de %s. <br>El coste de la'
    . ' construcción es  %s %s , %s %s y %s %s.';
...
$LNG['mg_delete_unmarked'] = 'Borrar los mensajes no marcados de este tipo';
...
$LNG['al_newname_specialchar'] = 'El nombre de la alianza y la fecha son sólo números, letras, espacios, _, -,.'
    . ' permitido!';
...
$LNG['al_request_deleted'] = 'Tu solicitud ha sido eliminada. <br/>Ahora puedes escribir una nueva solicitud o crear tu'
    . ' propia alianza.';
...
$LNG['al_diplo_info'] = '<p>En este lado de la alianza, la alianza será administrada.</p><p>Aquí encontrará la'
...
$LNG['op_admin_discord_id'] = 'Propio Discord UserID para ping para PM';
$LNG['op_admin_discord_hook'] = 'Discord webhook para el mensaje de PM';
...
$LNG['op_deactivate_ipcheck_descrip'] = 'La comprobación de IP significa que se realizará una desconección de seguridad'
    . ' automáticamente cuando cambie la IP o cuando 2 personas entren en la misma cuenta usando diferentes IPs.'
...
$LNG['op_show_message_category'] = 'Mostrar directamente la categoría de mensaje correspondiente';
...
$LNG['cff_mission_own_expo_2'] = 'Una %s de %s %s %s va de expedici&oacute;n m&aacute;s alla de la posici&oacute;n %s.'
    . ' Misi&oacute;n: %s';
$LNG['cff_mission_own_recy_0'] = 'Una %s de %s %s %s se dirige al campo de escombros en la posici&oacute;n %s.'
    . ' Misi&oacute;n: %s';
$LNG['cff_mission_own_recy_1'] = 'Una %s vuelve del campo de escombros en la posici&oacute;n %s hacia %s %s %s.'
    . ' Misi&oacute;n: %s';
$LNG['cff_mission_target_bad'] = 'Una %s hostil del jugador %s de %s %s %s espia la posici&oacute;n %s %s %s.'
    . ' Misi&oacute;n: %s';
$LNG['cff_mission_target_good'] = 'Una %s hostil del jugador %s de %s %s %s espia la posici&oacute;n %s %s %s.'
    . ' Misi&oacute;n: %s';
$LNG['cff_mission_target_stay'] = 'Una %s pac&iacute;fica del jugador %s de %s %s %s esta en orbita en %s %s %s.'
    . ' Misi&oacute;n: %s';
...
$LNG['fgr_time'] = 'Tiempo de reparación: ';
...
$LNG['ma_no_range'] = 'El objetivo no está al alcance de sus misiles.';
...
$LNG['pl_destroy'] = '%s estuvo involucrado en las siguientes destrucciones';
$LNG['pl_destroy_real'] = '%s ha destruido lo siguiente';
...
$LNG['ti_create_info'] = '<p>Por favor, perdóname. Al crear un nuevo Ticket de una línea de asunto descriptivo y'
    . ' explique sus preocupaciones con tanto detalle como sea posible.</p>
<p>Una descripción detallada de su problema o duda permite cortos tiempos de procesamiento y evita que se consuma mucho'
    . ' tiempo en preguntas de ida y vuelta..</p>
<p>cuestiones relacionadas con la cuenta, facilita la especificación de las cuentas de los clientes adecuados y la'
    . ' asignación también reduce el tiempo de procesamiento .</p>';
...
$LNG['kontakt'] =                   '¡Hola!<br>'
                                    .'En esta página encontrarás información sobre las personas que dirigen, moderan y desarrollan activamente este proyecto.<br>'
                                    .'No dudes en ponerte en contacto con nosotros si tienes alguna pregunta o problema.<br>'
                                    .'<br>'
                                    .'Para un mejor intercambio con nosotros, pero también con los otros coespilers, hemos creado un servidor Discord. '
                                    .'Puedes encontrarlo " <a href="https://discord.gg/jhYYN3yuat">aquí</a> " o a través del menú.<br>'
                                    .'En el servidor encontrarás las últimas noticias, así como emocionantes memes entre las alianzas del universo.<br>'
                                    .'Haz preguntas sobre la mecánica del juego y ayuda con tus propias sugerencias para el futuro desarrollo del juego.<br>'
                                    .'<br>'
                                    .'Por supuesto, también responderemos a tus quejas sobre el juego.<br>'
                                    .'Bedenke jedoch, dass auch wir das Spiel nur als Hobby betreiben. Las respuestas pueden tardar unos días.<br>';
...
$LNG['teamCommunityLong'] =         'Es la madre de la empresa.<br>Están a tu disposición si necesitas ayuda.<br>Sea cual sea tu preocupación, puedes ponerte en contacto con nosotros aquí y haremos todo lo posible por encontrar una solución.<br>Si tienes alguna pregunta o quieres desahogarte, aunque sea de forma anónima, puedes hacerlo aquí.<br>También somos responsables del enlace entre los jugadores y los mods.';
$LNG['teamNo'] =                    'No';
$LNG['teamYes'] =                   'Sí';
