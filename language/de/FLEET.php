...
$LNG['sys_expe_depleted_min_1'] 			= 'Logbuch Nachtrag des Kommunikationsoffiziers: Es scheint so, als ob bereits ein Mensch in diesem Bereich der Galaxis gewesen wäre.';
...
$LNG['sys_fleet_won'] 						= 'Eine deiner Flotten kehrt vom Angriff beim Planeten %s %s zurück zu %s %s. Sie haben %s %s, %s %s und %s %s erbeutet';
