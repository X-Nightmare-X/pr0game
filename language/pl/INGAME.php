...
$LNG['banned_message'] = 'Zostałeś zbanowany. Jeśli uważasz, że to nieporozumienie, napisz do nas przez Discord:'
...
$LNG['bd_requirements'] = 'Niespełnione wymagania';
$LNG['bd_on'] = 'na';
...
$LNG['sys_notenough_money'] = 'Na %s <a href="?page=buildings&amp;cp=%d&amp;re=0">[%d:%d:%d]</a> brakło środków do'
    . ' budowy %s. <br> Miałeś, %s %s , %s %s i %s %s. <br> a potrzebowałeś %s %s , %s %s i %s %s.';
...
$LNG['op_options_vacation_activated'] = 'Tryb wakacyjny włączony.';
$LNG['op_options_vacation_deactivated'] = 'Tryb wakacyjny wyłączony';
$LNG['op_options_deletion_activated'] = 'Usunięcie konta aktywowane.';
$LNG['op_options_deletion_deactivated'] = 'Usuwanie konta nieaktywne.';
$LNG['op_options_no_other_settings_changed'] = 'Żadne inne ustawienia nie zostały zmienione.';
...
$LNG['op_admin_discord_id'] = 'Własny identyfikator użytkownika Discord do pingowania dla PM';
$LNG['op_admin_discord_hook'] = 'Discord webhook dla wiadomości PM';
...
$LNG['op_stop_dlte_account'] = 'Anulowanie usuwania konta';
$LNG['op_email_adress_descrip'] = 'Możesz zmieniać adres tyle razy, ile chcesz. Po 7 dniach bez zmiany zostanie'
    . ' zapisany na stałe.';
$LNG['op_deactivate_ipcheck_descrip'] = 'Gdy do gry zaloguje się kolejna osoba z tym samym IP, zostaniesz wylogowany.'
...
$LNG['pl_destroy'] = '%s brał udział w następujących zniszczeniach';
$LNG['pl_destroy_real'] = '%s w rzeczywistości sam zniszczył';
...
$LNG['ti_create_info'] = '<p>Pisząc wiadomość do supportu wykaż się jak największą szczegółowością. Błąd opisz tak'
    . ' dokładnie, jak to tylko możliwe.</p>
<p>Dobrze opisany błąd pozwala na szybką identyfikację i uniknięcie czasochłonnego wypytywania, co, kiedy, gdzie,'
    . ' jak...</p>
<p>W wiadomości powinny znaleźć się takie informacje jak: co robiłeś, kiedy, jakie akcje były aktywne na koncie, czy'
    . ' trwała budowa, lot flot i wszystko inne, co może pomóc!</p>';
...
$LNG['teamRole'] =                  'Rola';
$LNG['teamPlayer'] =                'Gracz';
$LNG['teamAdmin'] =                 'Admin';
$LNG['teamAdminLong'] =             'Ma dostęp do specjalnych funkcji do administrowania grą';
$LNG['teamDatabase'] =              'Dostęp do bazy danych';
$LNG['teamTickets'] =               'Dostęp do biletów';
$LNG['teamTicketsLong'] =           'Może odczytać wszystkie otwarte bilety';
$LNG['teamScripte'] =               'Sprawdzanie skryptów';
$LNG['teamScripteLong'] =           'Ocenia skrypty stworzone przez graczy, aby Drużyna<br>mogła zdecydować, czy zezwolić na skrypt z funkcjami';
$LNG['teamMod'] =                   'Moderator';
$LNG['teamModLong'] =               'Zajmowanie się Twoimi sprawami/problemami<br>Stara się zapewnić uczciwe wrażenia z gry<br>Odpowiada za kary<br>Ma dostęp do sekcji Discord do dyskusji o modach<br>Ma dostęp do sekcji Discord do dyskusji deweloperów<br>Ma dostęp do sekcji Discord na spotkaniach z twórcami';
$LNG['teamEmergency'] =             'Zespół ratunkowy';
$LNG['teamEmergencyLong'] =         'Odbiera ping od użytkowników, gdy wystąpią awarie serwera';
$LNG['teamDev'] =                   'Wywoływacz';
$LNG['teamDevLong'] =               'Utrzymuje i rozwija projekt, Ma dostęp do obszaru Discord do dyskusji deweloperów, Ma dostęp do obszaru Discord na spotkania biletowe z moderatorami';
$LNG['teamNo'] =                    'Nie';
$LNG['teamYes'] =                   'I';
...
//----------------------------------------------------------------------------//
$LNG['found'] = 'Znaleziono ';
$LNG['expedition'] = 'Wyprawy';
$LNG['build'] = 'Budować';
$LNG['lost'] = 'Zagubiony';
$LNG['destroyed'] = 'Zniszczony';
$LNG['repaired'] = 'Naprawiono';
$LNG['other'] = 'Inne';
$LNG['advancedStats'] = 'Zaawansowane statystyki';
...
$LNG['Advanced_Stats'] = [
    ...
    'expo_count'                => 'Wyprawy',
    'expo_black_hole'           => 'Czarne dziury',
    'expo_pirates_small'        => 'Mali piraci',
    'expo_pirates_medium'       => 'Średni piraci',
    'expo_pirates_large'        => 'Duzi piraci',
    'expo_aliens_small'         => 'Mali kosmici',
    'expo_aliens_medium'        => 'Średni kosmici',
    'expo_aliens_large'         => 'Duzi kosmici',
    'expo_res_small'            => 'Małe znaleziska zasobów',
    'expo_res_medium'           => 'Średnie znaleziska zasobów',
    'expo_res_large'            => 'Duże znaleziska zasobów',
    'expo_ships_small'          => 'Małe znaleziska statków',
    'expo_ships_medium'         => 'Znaleziska średnich statków',
    'expo_ships_large'          => 'Znaleziska dużych statków',
    'expo_slow'                 => 'Slow Expeditions',
    'expo_fast'                 => 'Szybkie wyprawy',
    'expo_nothing'              => 'Wyprawy bez znalezisk',

    'moons_created'             => 'Utworzone księżyce',
    'moons_destroyed'           => 'Zniszczone księżyce',
    'moons_received'            => 'Otrzymane księżyce',
    'first_moon_trys'           => 'Próby dla pierwszego Księżyca',
    'destroy_moon_rips_lost'    => 'Zagubione Gwiazdy Śmierci próbujące zniszczyć księżyce',
    'set_sail_wins'             => 'Wygrane walki z aktywnym motywem SetSails',
