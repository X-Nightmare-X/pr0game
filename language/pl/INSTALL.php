...
$LNG['req_ftp_desc']			= 'Tutaj podaj dane dostępowe do serwera FTP, dzięki temu pr0game będzie mogło się automatycznie aktualizować. Alternatywnym sposobem jest robienie tego ręcznie.';
$LNG['req_ftp_host']			= 'Hostname';
$LNG['req_ftp_username']		= 'Nazwa użytkownika';
$LNG['req_ftp_password']		= 'Hasło';
$LNG['req_ftp_dir']				= 'Ścieżka do katalogu w którym jest zainstalowane pr0game';
