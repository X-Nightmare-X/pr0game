...
$LNG['banned_message'] = 'Engellendiniz. Bir yanlış anlaşılma olduğunu düşünüyorsanız Discord\'dan bize yazın:'
...
$LNG['ov_moon'] = 'Ay';
$LNG['ov_planets'] = 'Gezegenler ve uydular';
...
$LNG['bd_requirements'] = 'Gereklilikler yerine getirilmedi';
$LNG['bd_on'] = 'baglandi';
...
$LNG['sys_notenough_money'] = 'Hata %s <a href="./game.php?page=buildings&amp;cp=%d&amp;re=0">[%d:%d:%d]</a>de yeterli'
    . ' hammadde yok.  . <br> Insaa Edilmesi Emredilen Bina: %s. Sendeki mevcut hammadde %s %s , %s %s and %s %s.'
    . ' <br>Insaa icin gereken ise  %s %s , %s %s ve %s %s.';
...
$LNG['op_deactivate_ipcheck_descrip'] = 'IP kontrol. IP degistirilmesi ya da iki farkli kisinin farkli IP adresleri ile'
    . ' ayni isimle giris yapmalari durumunda, otomatik olarak guvenlik cikisi yapilmasini saglar, yani o an icin'
...
$LNG['cff_mission_own_0'] = 'Size ait <b> %s </b> %s %s %s koordinatindan kalkti ve %s %s %s koordinatlarina'
    . ' yaklasiyor. Gorevi: %s';
$LNG['cff_mission_own_1'] = 'Size ait <b>%s</b>  %s %s %s koordinatinda islemlerini tamamladi ve  %s %s %s'
    . ' koordinatlarina geri donuyor. Gorevi: %s';
$LNG['cff_mission_own_2'] = 'One of your %s from %s %s %s are in orbit around %s %s %s. Mission: %s';
$LNG['cff_mission_own_mip'] = 'Roket Saldirisi (%d)adet roket %s %s %s koordinatlarin ateslendi.%s %s %s koordinatina'
    . ' yaklasiyor..';
$LNG['cff_mission_own_expo_0'] = 'Size ait %s  %s %s %s  koordinatindan evreninin bilinmeyen noktasina %s'
    . ' yaklasiyorlar. Gorevi: %s';
$LNG['cff_mission_own_expo_1'] = 'Size ait %s evrenin bilinmeyen noktasindan %s,  %s %s %s koordinatina geri donuyor.'
    . ' Gorevi: %s';
$LNG['cff_mission_own_expo_2'] = 'Size ait %s from %s %s %s is on a Expedition to Position %s. Mission: %s';
$LNG['cff_mission_own_recy_0'] = 'Size ait %s,  %s %s %s koordinatindan %s yorungesindeki harabeye yaklasiyor.'
    . ' Gorevi: %s';
$LNG['cff_mission_own_recy_1'] = 'Size ait %s,  %s yorungesindeki harabe alanindan  %s %s %s koordinatlarina geri'
    . ' donuyor. Gorevi: %s';
$LNG['cff_mission_target_bad'] = 'Dusman %s, %s tarafindan %s %s %s koordinatindan %s %s %s koordinatina yaklasiyor.'
    . ' Gorevi: %s';
$LNG['cff_mission_target_good'] = 'Dost %s,  %s tarafindan  %s %s %s koordinatindan %s %s %s koordinatina yaklasiyor.'
    . ' Gorevi: %s';
$LNG['cff_mission_target_stay'] = 'Dost %s, %s tarafindan %s %s %s koordinatindan kalkti. Su an %s %s %s yorungesinde'
    . ' bulunmaktalar. Gorevi: %s';
$LNG['cff_mission_target_mip'] = 'Roket Saldirisi : (%d) adet roket  %s tarafindan %s %s %s koordinatlarindan'
    . ' ateslendi. Su an  on sizin %s %s %s koordinatlarina yaklasiyor..';
...
$LNG['pl_destroy'] = '%s aşağıdaki yıkımlara karışmıştır';
$LNG['pl_destroy_real'] = '%s aslında aşağıdakileri kendisi yok etti';
...
$LNG['ti_create_info'] = '<p> Dikkat, Bir destek bileti olustururken lutfen mumkun oldugu kadar detayli anlatiniz!</p>'
    . '<p>Sormak istediginiz soruyu net bir sekilde anlatiniz ve sorunun kisa surede hallolmasi icin onerilerinizi de'
    . ' bildiriniz</p><p>Ozellikle hesapla ilgili konularda detay vermek sorunun cabuk halledilmesi bakimindan'
    . ' onemli.</p>';
...
//----------------------------------------------------------------------------//
$LNG['found'] = 'Bulundu ';
$LNG['expedition'] = 'Keşif Gezisi';
$LNG['build'] = 'İnşa etmek';
$LNG['lost'] = 'Kayıp';
$LNG['destroyed'] = 'Yok edildi';
$LNG['repaired'] = 'Onarıldı';
$LNG['other'] = 'Diğer';
$LNG['advancedStats'] = 'Gelişmiş İstatistikler';
...
$LNG['Advanced_Stats'] = [
    ...
    'expo_count'                => 'Keşif Gezileri',
    'expo_black_hole'           => 'Kara Delikler',
    'expo_pirates_small'        => 'Küçük Korsanlar',
    'expo_pirates_medium'       => 'Orta Boy Korsanlar',
    'expo_pirates_large'        => 'Büyük Korsanlar',
    'expo_aliens_small'         => 'Küçük Uzaylılar',
    'expo_aliens_medium'        => 'Orta Boy Uzaylılar',
    'expo_aliens_large'         => 'Büyük Uzaylılar',
    'expo_res_small'            => 'Küçük Kaynak Bulguları',
    'expo_res_medium'           => 'Orta Ölçekli Kaynak Bulguları',
    'expo_res_large'            => 'Büyük Kaynak Bulguları',
    'expo_ships_small'          => 'Küçük Gemi Buluntuları',
    'expo_ships_medium'         => 'Orta Boy Gemi Buluntuları',
    'expo_ships_large'          => 'Büyük Gemi Buluntuları',
    'expo_slow'                 => 'Yavaş Keşifler',
    'expo_fast'                 => 'Hızlı Seferler',
    'expo_nothing'              => 'Bulgu bulunmayan keşifler',

    'moons_created'             => 'Aylar yaratıldı',
    'moons_destroyed'           => 'Aylar yok edildi',
    'moons_received'            => 'Aylar alındı',
    'first_moon_trys'           => 'İlk Ay\'ı deniyor',
    'destroy_moon_rips_lost'    => 'Kayıp Ölüm Yıldızları uyduları yok etmeye çalışıyor',
    'set_sail_wins'             => 'SetSails Teması etkinken savaşları kazandı',
