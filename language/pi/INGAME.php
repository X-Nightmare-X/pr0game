...
$LNG['ov_newname_specialchar'] = 'Im Hafennamen sind nur Zahlen, Buchstaben, Leerzeichen, _, -, . erlaubt!';
$LNG['ov_newname_done'] = 'Hafen erfolgreich umbenannt!';
$LNG['ov_planet_abandoned'] = 'Planet erfolgreich aufgegeben!';
$LNG['ov_principal_planet_cant_abanone'] = 'Sie können nicht ihren Haupthafen löschen!';
$LNG['ov_abandon_planet_not_possible'] = 'Hafen nicht löschbar, wenn Flottenaktivitäten zu oder von ihrer Kolonie'
    . ' stattfinden!';
...
$LNG['ov_diameter'] = 'Küstenlänge';
$LNG['ov_distance_unit'] = 'ft';
$LNG['ov_temperature'] = 'Temperatur';
$LNG['ov_aprox'] = 'ca. von';
$LNG['ov_temp_unit'] = '°C';
$LNG['ov_planets'] = 'Häfen und Inseln';
$LNG['ov_to'] = 'bis';
...
$LNG['fm_engines'] = 'Antriebstechnik';
//----------------------------------------------------------------------------//
//GALAXY

$LNG['gl_no_deuterium_to_view_galaxy'] = 'Sie haben nicht genügend Rum!';
$LNG['gl_legend'] = 'Legende';
$LNG['gl_colonizable'] = 'Kolonisierbar';
$LNG['gl_not_colonizable'] = 'Nicht kolonisierbar';
...
$LNG['gl_short_friend'] = '';
$LNG['gl_short_member'] = '';
$LNG['gl_populed_planets'] = '%d Häfen besiedelt';
$LNG['gl_out_space'] = 'Die unendlichen Weiten des Meeres';
$LNG['gl_avaible_missiles'] = 'Bomben';
...
$LNG['gl_missile_attack'] = 'Bombenangriff';
$LNG['gl_with'] = ' mit ';
...
$LNG['gl_diameter'] = 'Küstenlänge';
$LNG['gl_temperature'] = 'Temperatur';
$LNG['gl_phalanx'] = 'Krähennest';
$LNG['gl_planet_destroyed'] = 'Zerstörter Hafen';
...
$LNG['gl_free_desc'] = 'Ein großer unbesiedelter Hafen. Hier währe ein idealer Ort um eine neue Kolonie zu gründen.';
$LNG['gl_free'] = 'Frei';
$LNG['gl_yes'] = 'Ja';
$LNG['gl_no'] = 'Nein';
...
//----------------------------------------------------------------------------//
//PHALANX
$LNG['px_no_deuterium'] = 'Sie haben nicht genügend Rum!';
...
$LNG['fl_returning'] = 'Flotte auf Hafen';
$LNG['fl_onway'] = 'Flotte zu Hafen';
$LNG['fl_r'] = '(R)';
$LNG['fl_a'] = '(A)';
...
$LNG['fl_planet_populed'] = 'Hafen besiedelt!';
$LNG['fl_no_same_alliance'] = 'Der Spieler vom Ziel Hafen muss in deiner Allianz oder Buddyliste sein!';
$LNG['fl_not_ally_deposit'] = 'Am Ziel befindet sich kein Allianzdepo';
$LNG['fl_deploy_only_your_planets'] = 'Sie können nur Flotten auf Ihren eigenen Hafen stationieren!';
...
$LNG['fl_no_target'] = 'Kein Zielhafen vorhanden';
...
$LNG['fl_target_exists'] = 'Zielhafen existiert';
$LNG['fl_target_not_exists'] = 'Zielhafen existiert nicht!';
$LNG['fl_expedition_tech_required'] = 'Es wird die Forschung "Kolonisierungskunde" (Stufe 1 oder höher) benötigt, um eine'
    . ' Expedition zu starten.';
$LNG['fl_only_planets_colonizable'] = 'Nur Hafen können kolonisiert werden!';
$LNG['fl_player_is_noob'] = 'Spieler befindest sich im Noobschutz!';
$LNG['fl_player_is_strong'] = 'Spieler ist zu stark!';
$LNG['fl_no_hold_depot'] = 'Am Ziel befindet sich kein Anlegestelle.';
...
$LNG['fl_not_enough_deuterium'] = 'Nicht genügend Rum vorhanden.';
...
$LNG['fl_stronger_techs'] = 'Deine Angriffsstärke/Verteidigung/Holz sind zu niedrig.';
...
$LNG['sys_notenough_money'] = 'Sie verfügen auf Hafen %s <a href="?page=buildings&amp;cp=%d&amp;re=0">[%d:%d:%d]</a>'
...
$LNG['in_jump_gate_doesnt_have_one'] = 'Sie haben kein Sprungstrudel';
$LNG['in_jump_gate_already_used'] = 'Dieser Sprungstrudel ist noch nicht bereit: ';
...
$LNG['in_consumption'] = 'Rumverbrauch';
$LNG['in_jump_gate_start_moon'] = 'Ausgangspunkt Insel';
$LNG['in_jump_gate_finish_moon'] = 'Reiseziel Insel';
$LNG['in_jump_gate_select_ships'] = 'Verwenden des Sprungstrudels: Anzahl der Schiffe';
$LNG['in_jump_gate_wait_time'] = 'Nächst mögliche Nutzung:';
$LNG['in_jump_gate_jump'] = 'Aufladen';
$LNG['in_jump_gate_no_target'] = 'Kein Ziel Sprungstrudels vorhanden.';
$LNG['in_destroy'] = 'Abreißen';
$LNG['in_needed'] = 'Benötigt';
$LNG['in_dest_durati'] = 'Dauer';
$LNG['in_missilestype'] = 'Bombentyp';
...
$LNG['al_users_list_main'] = 'Main-Memberliste (Spieler: %d) - %s';
...
$LNG['al_make_ally_insufficient_points'] = 'Du hast nicht genug Punkte, um eine Allianz zu gründen.<br>Du benötigst'
    . ' mindestenst %s Punkte, dir fehlern %s Punkte.';
...
$LNG['al_diplo_accept_yes_confirm'] = 'Möchtst Du den Pakt wirklich annehmen?';
...
$LNG['al_diplo_accept_no_confirm'] = 'Möchtst Du den Pakt wirklich ablehnen?';
...
$LNG['al_diplo_withdraw_confirm'] = 'Möchtest Du die Paktanfrage wirklich zurückziehen?';
...
$LNG['al_diplo_exists'] = 'Es existiert bereits eine gültige oder noch nicht akzeptierte diplomatische Beziehung mit'
    . ' der Allianz "%s"!';
$LNG['al_diplo_info'] = '<p>Auf dieser Seite können die Bündnisse der Allianz verwaltet werden.</p><p>Hier findest du'
...
$LNG['sh_search_in_the_universe'] = 'Suche im Weltmeer';
$LNG['sh_player_name'] = 'Spieler Name';
$LNG['sh_planet_name'] = 'Hafen Name';
...
$LNG['op_sort_planets_by'] = 'Häfen sortieren nach';
...
$LNG['op_galaxy_settings'] = 'Weltmeeransicht Einstellungen';
$LNG['op_spy_probes_number'] = 'Papageien Anzahl';
...
$LNG['op_missile_attack'] = 'Bombenangriff';
...
$LNG['op_deactivate_ipcheck_descrip'] = 'IP-Check bedeutet, dass automatisch ein Sicherheitslogout erfolgt, wenn die IP'
    . ' gewechselt wird oder zwei Leute gleichzeitig unter verschiedenen IPs in einem Account eingeloggt sind. Den'
...
$LNG['cff_mission_own_mip'] = 'Bombenangriff (%d) vom %s %s %s auf den %s %s %s.';
...
$LNG['cff_mission_target_stay'] = 'Eine friedliche %s vom Spieler %s vom %s %s %s ist im Meer von dem %s %s %s.'
    . ' Mission: %s';
$LNG['cff_mission_target_mip'] = 'Bombangriff (%d) vom Spieler %s vom %s %s %s auf den %s %s %s.';

//----------------------------------------------------------------------------//
// EXTRA LANGUAGE FUNCTIONS
$LNG['fcm_universe'] = 'Universum';
$LNG['fcm_mainplanet'] = 'Haupthafen';
$LNG['fcm_planet'] = 'Hafen';
$LNG['fcm_moon'] = 'Insel';
...
$LNG['sys_refferal_text'] = 'Der von dir geworbene Spieler %s hat nun %s Punkte erreicht.';
$LNG['sys_closed_game'] = 'Das Weltmeer ist zur Zeit nicht verfügbar:';
...
$LNG['cr_type'] = 'Typ';
$LNG['cr_total'] = 'Total';
$LNG['cr_weapons'] = 'Kanonen';
$LNG['cr_shields'] = 'Holz';
$LNG['cr_armor'] = 'Schiffsbau';
$LNG['cr_destroyed'] = 'Zerstört!';

//----------------------------------------------------------------------------//
// FleetAjax.php
$LNG['fa_not_enough_probes'] = 'Fehler, keine Papageien vorhanden';
$LNG['fa_galaxy_not_exist'] = 'Fehler, Ozean nicht vorhanden';
$LNG['fa_system_not_exist'] = 'Fehler, Meer nicht vorhanden';
$LNG['fa_planet_not_exist'] = 'Fehler, Hafen nicht vorhanden';
$LNG['fa_not_enough_fuel'] = 'Fehler, nicht genügend Rum vorhanden';
$LNG['fa_no_more_slots'] = 'Fehler, keine Slots verfügbar';
$LNG['fa_no_recyclers'] = 'Fehler, keine Wracktaucher vorhanden';
$LNG['fa_no_fleetroom'] = 'Fehler, Rumverbrauch größer als Transportkapazität';
$LNG['fa_mission_not_available'] = 'Fehler, Mission nicht verfügbar';
$LNG['fa_no_spios'] = 'Fehler, keine Papageien vorhanden';
...
$LNG['market_p_msg_sent'] = 'Sende %s Kleine Handelsschiffe, %s Große Handelsschiffe';
...
//----------------------------------------------------------------------------//
// MissilesAjax.php
$LNG['ma_silo_level'] = 'Du benötigst Bombenstation Stufe 4!';
...
$LNG['ma_misil_launcher'] = '12-Pfünder';
$LNG['ma_small_laser'] = 'Balliste';
$LNG['ma_big_laser'] = 'Feuerballiste';
$LNG['ma_gauss_canyon'] = '30-Pfünder';
$LNG['ma_ionic_canyon'] = 'Kartätsche';
$LNG['ma_buster_canyon'] = 'Mörser';
$LNG['ma_small_protection_shield'] = 'Holzwall';
$LNG['ma_big_protection_shield'] = 'Steinwall';
$LNG['ma_all'] = 'Alle';
$LNG['ma_missiles_sended'] = ' Bomben gesendet. Zerstörte Objekte: ';
...
$LNG['build'] = 'Gebaut';
$LNG['lost'] = 'Verloren';
$LNG['destroyed'] = 'Zerstört';
$LNG['repaired'] = 'Repariert';
$LNG['other'] = 'Anderes';
$LNG['advancedStats'] = 'Erweiterte Statistiken';

$LNG['stats'] = [
    202 => 'Kleine Handelsschiffe',
    203 => 'Große Handelsschiffe',
    204 => 'Leichte Brigs',
    205 => 'Schwere Brigs',
    206 => 'Schoner',
    207 => 'Korvette',
    ...
    407 => 'Holzwälle',
    408 => 'Steinwälle',
    409 => 'Gigantische Schildkuppeln',
    410 => 'Gravitonkanonen',
    411 => 'Orbitale Verteidigungsplattformen',

    502 => 'Löschvorrichtungen',
    503 => 'Brandbomben',
...
$LNG['Advanced_Stats'] = [
    ...
    'expo_count'                => 'Expeditionen',
    'expo_black_hole'           => 'Schwarze Löcher',
    'expo_pirates_small'        => 'Kleine Piraten',
    'expo_pirates_medium'       => 'Mittlere Piraten',
    'expo_pirates_large'        => 'Große Piraten',
    'expo_aliens_small'         => 'Kleine Aliens',
    'expo_aliens_medium'        => 'Mittlere Aliens',
    'expo_aliens_large'         => 'Große Aliens',
    'expo_res_small'            => 'Kleine Ressourcenfunde',
    'expo_res_medium'           => 'Mittlere Ressourcenfunde',
    'expo_res_large'            => 'Große Ressourcenfunde',
    'expo_ships_small'          => 'Kleine Schiffsfunde',
    'expo_ships_medium'         => 'Mittlere Schiffsfunde',
    'expo_ships_large'          => 'Große Schiffsfunde',
    'expo_slow'                 => 'Langsame Expeditionen',
    'expo_fast'                 => 'Schnelle Expeditionen',
    'expo_nothing'              => 'Leere Expeditionen',

    'moons_created'             => 'Geschossene Inseln',
    'moons_destroyed'           => 'Zerstörte Inseln',
    'moons_received'            => 'Erhaltene Inseln',
    'first_moon_trys'           => 'Versuche für die erste Insel',
    'destroy_moon_rips_lost'    => 'Verlorene Schwimmende Festungen bei Inselzerstörungen',
    'set_sail_wins'             => 'Gewonnene Kämpfe mit SetSails Theme',
