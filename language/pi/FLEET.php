...
$LNG['sys_mess_qg'] = 'Papageienabteilung';
$LNG['sys_mess_spy_report_moon'] = '(Insel)';
$LNG['sys_mess_spy_report'] = 'Papageienbericht';
$LNG['sys_mess_head'] = 'Papageienbericht von %s [%d:%d:%d] am %s';
...
$LNG['sys_mess_spy_ennemyfleet'] = 'Eine feindliche Flotte vom Hafen';
