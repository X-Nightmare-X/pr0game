...
$LNG['sys_attack_techologies'] = 'Kanonen: %d %% Holz: %d %% Schiffsbau: %d %% ';
$LNG['sys_attack_defender_pos'] = 'Verteidiger';
$LNG['sys_ship_type'] = 'Typ';
$LNG['sys_ship_count'] = 'Anzahl';
$LNG['sys_ship_weapon'] = 'Bewaff.';
$LNG['sys_ship_shield'] = 'Holzbeschaff.';
$LNG['sys_ship_armour'] = 'Schiffsbauw.';
...
$LNG['fleet_attack_2'] = 'auf den Verteidiger. Das Holz des Verteidigers absorbiert';
$LNG['fleet_defs_1'] = 'Die Verteidigende Flotte schiesst mit einer Leistung von';
$LNG['fleet_defs_2'] = 'auf den Angreifer. Das Holz des Angreifers absorbiert';
...
$LNG['sys_mess_spy_qg'] = 'Papageienabteilung';
$LNG['sys_mess_spy_report'] = 'Papageienbericht';
$LNG['sys_mess_spy_report_details_1'] = 'Papageienbericht vom Hafen %1$s (%2$s) [%3$s:%4$s:%5$s] am %6$s';
$LNG['sys_mess_spy_report_details_3'] = 'Papageienbericht von der Insel %1$s (%2$s) [%3$s:%4$s:%5$s] am %6$s';
$LNG['sys_mess_spy_lostproba'] = 'Die Wahrscheinlichkeit für Absturz der Papageien beträgt: %d %% ';
$LNG['sys_mess_spy_control'] = 'Papageienüberwachung';
$LNG['sys_mess_spy_activity'] = 'Papageien-Aktivität';
$LNG['sys_mess_spy_link'] = '<a href="game.php?page=galaxy&amp;galaxy=%3$s&amp;system=%4$s">%1$s (%2$s) [%3$s:%4$s:%5$s]</a>';
$LNG['sys_mess_spy_ennemyfleet_1'] = 'Feindliche Papageien vom Hafen %s wurde in der Nähe von %s gesichtet.';
$LNG['sys_mess_spy_ennemyfleet_3'] = 'Feindliche Papageien von der Insel %s wurde in der Nähe von %s gesichtet.';
$LNG['sys_mess_spy_destroyed'] = 'Deine Papageien sind abgestürzt!';
...
$LNG['sys_colo_notech'] = 'Eine deiner Flotten erreicht die Koordinaten %s. Als sich deine Siedler dem Hafen'
...
$LNG['sys_colo_maxcolo'] = 'Eine deiner Flotten erreicht die Koordinaten %s. Eine Besiedelung ist nicht möglich, da du'
    . ' nicht mehr als %d Häfen haben kannst.';
$LNG['sys_colo_allisok'] = 'Eine deiner Flotten erreicht die Koordinaten %s. Die Siedler beginnen den neuen Hafen zu'
    . ' besiedeln.';
...
$LNG['sys_recy_mess'] = 'Eine deiner Wracktaucher-Gruppen kehrt nach %s %s mit %s %s, %s %s und %s %s zurück.';
...
$LNG['sys_expe_found_ships'] = 'Deine Forscher haben Schiffe in einwandfreiem Zustand gefunden!.<br>Bergen konnten'
    . ' Sie: ';
$LNG['sys_expe_found_ress_1_1'] = 'Deine Expedition hat einen kleinen haufen Treibgut entdeckt, aus dem einige'
    . ' Ressourcen gewonnen werden können.';
$LNG['sys_expe_found_ress_1_2'] = 'Auf einer abgelegen Insel wurden einige leicht zugängliche Ressourcenfelder'
    . ' gefunden und erfolgreich Rohstoffe gewonnen.';
$LNG['sys_expe_found_ress_1_3'] = 'Deine Expedition stieß auf sehr alte Schiffwracks einer längst vergangenen'
    . ' Schlacht. Einzelne Komponenten konnte man bergen und recyceln.';
$LNG['sys_expe_found_ress_1_4'] = 'Die Expedition stieß auf einen versteckten Schatz der von Skeletten verteidigt wird.'
    . ' Deine Papageien haben eine Schleichroute über die du dich an den Skeletten vorbei schleichen kannst'
...
$LNG['sys_expe_found_ress_2_1'] = 'Deine Expedition fand einen uralten, voll beladenen, aber menschenleeren'
    . ' Handelskonvoi. Einige Ressourcen konnten geborgen werden.';
$LNG['sys_expe_found_ress_2_2'] = 'Auf einer kleinen Insel fand deine Expedition große'
    . ' Rohstoffvorkommen. Die Crew ist dabei diese natürlichen Schätze zu heben.';
...
$LNG['sys_expe_found_ress_3_1'] = 'Deine Expeditionsflotte meldet den Fund eines riesigen Marine-Schiffswracks. Mit der'
    . ' Schiff selbst konnten sie zwar nichts anfangen, aber das Schiff ließ sich in seine Einzelteile zerlegen und'
    . ' dadurch konnte man wertvolle Rohstoffe gewinnen.';
$LNG['sys_expe_found_ress_3_2'] = 'Am Strand einer unbekannten Insel liegen Unmengen an Rohstoffen.'
...
$LNG['sys_expe_found_ships_1_2'] = 'Wir haben eine verlassene Piratenbasis gefunden. Im Hangar liegen noch einige alte'
    . ' Schiffe. Unsere Schiffsbauer schauen nach, ob einige davon noch zu gebrauchen sind.';
$LNG['sys_expe_found_ships_1_3'] = 'Unsere Expedition fand ein Insel, die wohl durch anhaltende Kriege fast'
    . ' komplett zerstört wurde. In einer Bucht trieben diverse Schiffswracks. Die Schiffsbauer versuchen, einige davon'
    . ' zu reparieren. Vielleicht erhalten wir so auch Information darüber, was hier geschehen ist.';
$LNG['sys_expe_found_ships_1_4'] = 'Deine Expedition ist auf eine alte Piratenfestung gestoßen, die wohl seit'
    . ' Ewigkeiten verlassen ist. In der Werft der Festung wurden ein paar Schiffe gefunden. Die Schiffsbauer schauen, ob sie'
    . ' einige davon wieder flott bekommen. ';
$LNG['sys_expe_found_ships_2_1'] = 'Wir haben die Reste einer Armada gefunden. Die Schiffsbauer der Expeditionsflotte'
    . ' haben sich sofort auf die halbwegs intakten Schiffe begeben und versuchen, diese wieder instandzusetzen.';
$LNG['sys_expe_found_ships_2_2'] = 'Unsere Expedition stieß auf eine unbemannte, geheime Schiffswerft. Einige Schiffe'
    . ' sind noch in der Produktionsphase, und unsere Schiffsbauer versuchen, die Schiffe aus der Werft'
    . ' wiederherzustellen.';
$LNG['sys_expe_found_ships_3_1'] = 'Wir haben einen riesigen Schiffsfriedhof gefunden. Einigen Schiffsbauern der'
    . ' Expeditionsflotte ist es gelungen, das eine oder andere Schiff wieder in Betrieb zu nehmen.';
$LNG['sys_expe_found_ships_3_2'] = 'Wir haben einen Insel mit Resten einer Zivilisation entdeckt. Aus dem Ferne ist'
    . ' noch ein riesiger Hafen zu erkennen, der als einziges Gebäude noch intakt ist. Einige unserer Techniker'
    . ' und Matrosen haben sich an Land begeben um nachzuschauen, ob ein paar der dort abgestellten Schiffe'
    . ' noch zu gebrauchen sind.';
$LNG['sys_expe_found_ships_logbook_1'] = 'Logbuch Nachtrag des ersten Maats: Wenn wir doch nur ein paar Schiffe'
    . ' mehr dabei gehabt hätten! Dann wäre es ein leichtes gewesen noch mehr von diesen Prachtstücken ab zu'
    . ' schleppen.';
$LNG['sys_expe_found_ships_logbook_2'] = 'Logbuch Nachtrag des ersten Maats: Leider haben wir nicht genug Tonnage'
    . ' um all die schönen Schiffe nach Hause zu bringen.';
$LNG['sys_expe_found_ships_logbook_3'] = 'Logbuch Nachtrag des ersten Maats: Wir verfügen leider nicht über'
    . ' genügend Tonnage, um alle gefundenen Schiffe zurückzubringen.';
$LNG['sys_expe_lost_fleet_1'] = 'Von der Expedition ist nur noch folgender Logbucheintrag übrig geblieben: Die Strömung treibt uns in einen Strudel!'
    . ' Wir geben unser bestes aus dem Strudel zu rudern. Der Fall scheint allerdings hoffnungslos!';
$LNG['sys_expe_lost_fleet_2'] = 'Das Letzte, was von dieser Expedition noch gefunden wurde, waren Wrackteile die sich im Ozean verteilten.';
$LNG['sys_expe_lost_fleet_3'] = 'Ein Explosion eines Pulverfasses des Führungsschiffes führte zu einer Kettenreaktion, die in einer'
    . ' durchaus spektakulären Explosion die gesamte Expedition vernichtete.';
$LNG['sys_expe_lost_fleet_4'] = 'Die Expeditionsflotte ist in den Weltmeeren verschwunden!';
$LNG['sys_expe_time_fast_1'] = 'Eine unvorhergesehene Strömung'
    . ' beschleunigte den Rückweg der Expedition, so dass sie nun früher als erwartet zurückkehrt. Ersten Meldungen'
    . ' zufolge hat sie jedoch nichts Spannendes zu berichten.';
$LNG['sys_expe_time_fast_2'] = 'Der etwas wagemutige neue Navigator nutzte eine selbstgezeichnete Karte, um den Rückweg zu'
    . ' verkürzen – mit Erfolg! Jedoch hat die Expedition selbst keine neuen Erkenntnisse gebracht.';
$LNG['sys_expe_time_fast_3'] = 'Deine Expedition meldet keinen Besonderheiten in dem erforschten Gewässer. Jedoch geriet'
    . ' die Flotte auf der Rückfahrt an den Rand eines Strudels. Dadurch wurde die Flotte ziemlich beschleunigt. Deine'
    . ' Expedition kehrt nun etwas früher nach Hause.';
$LNG['sys_expe_time_slow_1'] = 'Ein böser Patzer des Navigators führte zu einer Fehlkalkulation beim festlegen des Kurses der'
...
$LNG['sys_trade_mess_arr_success'] = 'Eine deiner Handelsflotten ist bereit zur Rückkehr zum Hafen %1$s %2$s. <form action="game.php?page=fleetTable&amp;action=sendfleetback" method="post">'
