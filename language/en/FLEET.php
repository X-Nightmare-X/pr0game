...
$LNG['sys_expe_depleted_min_1'] 			= 'Entry from the communications officers logbook: It seems that humans have been in this part of the galaxy before.';
...
$LNG['sys_fleet_won'] 						= 'One of your fleets returns from a attack at the planet %s %s to %s %s. You have captured %s %s, %s %s and %s %s';
$LNG['sys_lost'] 							= 'Losses';
