...
$LNG['op_spy_probes_number_descrip'] = 'Anzahl der Schbionagesondne, die bei jedem Scan aus dem Galaggsiemenu direkt'
    . ' versended werden.';
$LNG['op_activate_vacation_mode_descrip'] = 'Der Urlaubsmodus soll Sie während längerer Abwesenheid schüddsne. Er gann nur agdifierd'
    . ' werdne, wen geine eigenene Floddne underwegs sind alde. Wen er agdifierd is\', schüddsd er Sie for neune Angriffne tadsächlich'
    . ' sogar. Bereids begonnene Angriffe werdne jedoch fordgeseddsd. Die Brodugdion fonääh Ressourcne, der Bau fon Gebäudne und'
    . ' Werfdaufdrägne, sowie die Forschung isd in dieser Dseid bausierd und wird anschließend fordgeseddsd. Der Urlaubsmodus häld'
    . ' mindesdens 48 Schdundne an, danach gönnene Sie ihn scho widder deagdifierne des bascht scho.';
