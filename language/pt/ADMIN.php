...
$LNG['info_information'] = 'Enviar ou reportar bugs no forum <a href="%s" target="tracker">pr0game</a><br>De outro modo'
    . ' não haverá suporte!';
...
//---------------   Pagina Inicial  ------------------------//
$LNG['ow_title'] = 'Bem vindo ao pr0game!';
$LNG['ow_donate'] = 'Doar';
$LNG['ow_welcome_text'] = 'Bem vindo ao popular pr0game! (:';
...
$LNG['ow_config_file_writable'] = 'O ficheiro config.php pode ser escrito, editado ou apagado! É recomendado por em'
    . ' modo 440 (leitura somente).';
...
$LNG['se_expo_hold_multiplier'] = 'Velocidade de expedição';
...
$LNG['se_cookie_advert'] = 'Quando alterar o nome do Cookie deve voltar a fazer login. <br>E recomendado alterar o nome'
    . ' se tiveres varios universos.';
...
$LNG['se_max_additional_planets'] = 'Numero máximo de colonias com pesquisa';
$LNG['se_max_additional_planets_info'] = 'Numero de colonias no máximo que o jogador pode possuir com Exploração Espacial';
...
$LNG['se_ref_active_info'] = 'Referral Link , ou o link de Convite dá aos jogadores a oportunidade de referir, ou'
    . ' atrair e convidar mais amigos. Isto vai dar bônus para os jogadores.';
...
$LNG['se_min_build_time_info'] = 'Aqui poderás por um tempo minimo para construção. Esta pré defenido para 1 segundo.'
    . '<br>Se alterares para 0, será desativado<br>';
...
$LNG['se_smtp_info'] = 'Introduza os dados do Servidor de SMTP para permitir a comunicação entre o servidor do pr0game'
    . ' e os seus jogadores pelo Servidor de Email SMTP.';
...
$LNG['se_google_info'] = 'Google Analitico é a solução para web sites que lhe permite adquirir conhecimentos valiosos'
    . ' sobre o tráfego do seu site e do impacto das suas estratégias de marketing. Graças ao poderoso, flexível e'
    . ' características user-friendly prog agora podes acessar aos teus dados em novas formas de analisar e mostrar.'
    . ' Com o Google Analitico podes projetar a tua publicidade segmentada, fortes campanhas de marketing e'
    . ' desenvolvimento de sites com altas taxas de conversão.';
...
$LNG['se_max_initial_planets'] = 'Máximo de Planetas';
...
$LNG['se_max_initial_planets_info'] = 'Numero máximo de colonias com a pesquisa';
$LNG['se_planet_size_factor'] = 'Tamanho do Planeta.';
$LNG['se_planet_size_factor_info'] = 'Multiplicador do tamanho do Planeta';
$LNG['se_all_planet_pictures'] = 'Todas as imagens planetárias.';
$LNG['se_all_planet_pictures_info'] = 'Permite todos os licitantes planetários em todas as posições';
...
$LNG['se_planet_ressource_bonus'] = 'Aumento de recursos relacionado com a posição do planeta';
$LNG['se_planet_ressource_bonus_info'] = 'Aumenta a quantidade de recursos produzidos no planeta em x %, dependendo da posição do planeta';
...
$LNG['se_jumpgate_factor'] = 'Portal Quantico';
$LNG['se_jumpgate_factor_info'] = 'Fator pelo qual o tempo de espera será dividido';
...
$LNG['se_moon_size_factor'] = 'Fator de tamanho da lua';
$LNG['se_moon_size_factor_info'] = 'Fator que influencia o tamanho da lua, 1 = predefinição';
...
$LNG['se_discord_exceptions_hook'] = 'Excepções e avisos';
...
//---------------   Frotas em voo   ------------------------//
$LNG['ff_sendFleetsBack'] = 'Devolver todos os ataques';
$LNG['ff_sendFleetBack'] = 'Regresso';
...
$LNG['mu_mpu_confirmation'] = 'O atualizador de pontos é automatico, isso permite ver o que é que o teu servidor esta'
    . ' atualmente a fazer (Como memoria consumida , SQL , etc.)';
...
$LNG['vt_info'] = 'Esta lista contém os arquivos que foram modificados e não corresponde ao original.<br>Se não mudaste'
    . ' mesmo o jogo, deves substituir os arquivos com os originais.';
...
$LNG['re_reset_universe_confirmation'] = 'Ao clicar em OK, a base de dados será toda limpa (Excepto tabelas). Ao fazer'
    . ' esta opção, não existe retorno, a não ser com um backup da base de dados!';
...
$LNG['se_confirm_planet'] = 'O planeta escolhido será completamente apagado, mesmo sendo planeta principal ou colonia,'
    . ' queres continuar?. Nome do planeta:';
...
$LNG['modul_41'] = 'Atalhos de Frotas';
...
$LNG['up_need_curl'] = 'Erro: O CURL não está presente.<br />A atualização do pr0game requer cURL para executar'
    . ' download dos ficheiros.';
$LNG['up_no_xml_ext'] = 'Erro: XML Parser não está presente.<br />A atualização do pr0game requer XML Parser para'
    . ' processar os ficheiros presentes.';
...
$LNG['cronjob_desc'] = 'Aqui segue a entrada dos tempos para as Cronjobs. As condições são conectados e, o que'
    . ' significa que o cronjob será executado somente se todas as condições existirem.';
$LNG['cronjob_desc_name'] = 'Nome livremente selecionável para identificar as tarefas agendadas (Cronjobs).';
$LNG['cronjob_desc_class'] = 'Entrada da classe a ser invocado. "Includes/classes/cronjobs/foo.class.php" "foo" deve'
    . ' ser inserido.';
