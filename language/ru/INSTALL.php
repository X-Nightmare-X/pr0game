...
$LNG['intro_welcome']         = 'Добро пожаловать в pr0game!';
$LNG['intro_text']            = 'pr0game - один из лучших клонов OGame.<br>pr0game является самым стабильным и развивающимся движком из всех подобных XNova на данный момент. Мы надеемся, что pr0game будет лучше, чем Вы ожидаете.<br><br>Если у Вас будут вопросы, консультируйтесь с нами.<br><br>pr0game является проектом с открытым кодом и распространяется под лицензией GNU GPL v3, ознакомиться с которой Вы можете в разделе Лицензия.<br><br>Перед установкой будет запущен небольшой тест на соответствие минимальным требованиям.';
$LNG['intro_upgrade_head']    = 'pr0game уже установлена';
$LNG['intro_upgrade_text']    = '<p>Вы уже установили pr0game и просто хотите её обновить?</p><p>Здесь вы можете обновить старую базу данных с помощью нескольких кликов.</p>';
...
$LNG['upgrade_required_rev']  = 'Мастер обновления базы данных доступен с ревизии r2579 (pr0game v1.7).';
...
$LNG['req_desc']              = 'Перед продолжением установки pr0game выполнит проверку файлов конфигурации Вашего сервера на соответствие необходимым требованиям использования pr0game. Пожалуйста, прочитайте внимательно результаты и не продолжайте установку, пока проверка не будет пройдена по всем пунктам. Если Вы хотите использовать любую из функций перечисленных ниже модулей, Вы должны убедиться, что проверка пройдена.';
$LNG['reg_yes']               = 'Да';
$LNG['reg_no']                = 'Нет';
$LNG['reg_found']             = 'Да';
...
$LNG['req_php_need_desc']     = '<strong>Требование</strong> — PHP является серверным языком, на котором написана игра. pr0game работает без ограничений, используя версию PHP 5.2.5 и выше.';
...
$LNG['reg_global_desc']       = 'pr0game будет корректно работать, если этот параметр включён. Тем не менее, рекомендуется по соображениям безопасности, отключить register_globals в настройках PHP.';
...
$LNG['req_ftp_dir']           = 'FTP путь к pr0game';
...
$LNG['step1_desc']            = 'pr0game может быть установлена на Вашем сервере, но Вы должны указать настройки доступа к базе данных. Если Вы не знаете настройки доступа для подключения к базе данных, узнайте их у Вашего хостинг-провайдера или связитесь с технической поддержкой pr0game для консультации. При вводе данных, пожалуйста, проверьте их внимательно, прежде чем продолжить.';
...
$LNG['step3_desc']            = 'Таблицы базы данных созданы и заполнены. Переходите к следующему шагу, чтобы завершить установку pr0game.';
...
$LNG['step6_desc']            = 'Вы установили pr0game.';
$LNG['step6_info_head']       = 'Начните использовать pr0game.';
...
$LNG['sql_welcome']           = 'Добро пожаловать в pr0game v';