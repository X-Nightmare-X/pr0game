...
$LNG['loginUsername']               = 'Логин/электронная почта';
...
$LNG['loginUsernamePMSenderName']	= 'Администратор';
$LNG['loginUsernamePMSubject']	    = 'Внимание: Смена логина';
$LNG['loginUsernamePMText']		    = 'В связи с угрозой безопасности при входе в систему через имя пользователя, в ближайшее время логин будет заменен на сохраненный адрес электронной почты.<p>'
    . 'Пожалуйста, войдите в систему, используя только адрес электронной почты. Вы можете найти его в меню настроек.';
...
// Ошибки авторизации
$LNG['login_error_1']               = 'Неправильное имя пользователя, электронная почта или пароль!';
...
$LNG['login_error_4']				= 'Было предпринято слишком много попыток входа. Пожалуйста, свяжитесь с администратором через Discord, чтобы получить новые данные для входа. Приготовьте свой адрес электронной почты для проверки.';
