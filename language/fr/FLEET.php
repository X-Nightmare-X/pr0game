...
$LNG['sys_def_rebuild'] = 'Les installations de défense ont pu être partiellement réparées :';
$LNG['sys_ship_repaired'] = 'Réparé';
...
$LNG['sys_mess_spy_qg'] = 'Département Espionnage';
$LNG['sys_mess_spy_report'] = 'Rapport d\'espionnage';
$LNG['sys_mess_head'] = 'Rapport d espionnage %s ( %s ) [%d:%d:%d] sur %s';
$LNG['sys_mess_spy_report_details_1'] = 'Rapport d\'espionnage de la planète %1$s (%2$s) [%3$s:%4$s:%5$s] sur %6$s';
$LNG['sys_mess_spy_report_details_3'] = 'Rapport d\'espionnage de la lune %1$s (%2$s) [%3$s:%4$s:%5$s] sur %6$s';
...
$LNG['sys_stat_mess'] = 'Votre Flotte atteint la %s %s et y délivre %s %s, %s %s and %s %s.';
...
$LNG['sys_recy_mess'] = 'Une de tes flottes de recycleurs revient à %s %s avec %s %s, %s %s et %s %s.';
...
$LNG['sys_tran_mess_owner'] = 'Une de vos flottes de %s %s atteint la %s %s %s et y delivre %s %s, %s %s et %s %s.';
...
$LNG['sys_trade_mess_back'] = 'Une de vos flottes commerciales retourne sur la planète %s %s sans succès.';
$LNG['sys_trade_mess_back_success'] = 'Une de vos flottes marchandes est revenue avec succès sur la planète %4$s %5$s avec %1$s de métal, %2$s de cristal et %3$s de deutérium.';
$LNG['sys_trade_mess_arr_success'] = 'Une de vos flottes marchandes est prête à retourner sur la planète %1$s %2$s. <form action="game.php?page=fleetTable&amp;action=sendfleetback" method="post">'
...
$LNG['spy_potential_recycling'] = 'Potentiel de recyclage';
$LNG['spy_necessary_transporters'] = 'Transporteurs nécessaires';
$LNG['spy_necessary_recycler'] = 'Recycleurs nécessaires';
$LNG['spy_market_value'] = 'Valeur marchande';
$LNG['spy_energy'] = 'Énergie';
$LNG['spy_best_resources_per_second'] = 'Meilleure résolution par seconde';
$LNG['spy_best_planet'] = 'Mejor Planeta';
$LNG['spy_attack_with'] = 'Attaquez avec';
$LNG['spy_small_transporter'] = 'petit transporteur';
$LNG['spy_large_transporter'] = 'grand transporteur';
