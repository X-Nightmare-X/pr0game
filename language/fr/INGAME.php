...
$LNG['ov_newname_specialchar'] = 'Le nom de planètes doit être constitué exclusivement de chiffres, de lettres,'
    . ' d\'espaces ou , _, -,..';
...
$LNG['ov_abandon_planet_not_possible'] = 'Une Colonie ne peut être abandonnée si il y a des mouvements de flotte depuis'
    . ' ou vers elle !';
...
$LNG['fl_no_same_alliance'] = 'Le joueur de la planète cible doit faire partie de votre alliance ou de votre liste'
    . ' d\'amis !';
...
$LNG['fl_trade_no_resource_loaded'] = 'Vous n\'avez chargé aucune ressource.';
$LNG['fl_trade_to_many_resources_loaded'] = 'Vous ne pouvez vendre qu\'une seule ressource.';
$LNG['fl_trade_same_resource'] = 'Vous ne pouvez pas vendre %s pour %s.';
$LNG['fl_not_enough'] = 'Pas assez de %s disponibles.';
...
$LNG['bd_wreck_count'] = 'Épaves dans le champ d\'épaves';
$LNG['bd_repair_rate'] = 'Taux de réparation';
...
$LNG['bd_requirements'] = 'Exigences non remplies';
$LNG['bd_on'] = 'sur';
...
$LNG['sys_notenough_money'] = 'Vous n\'avez pas assez d\'argent %s <a href="./game.php?page=buildings&cp=%d&re=0">'
    . '[%d:%d:%d]</a> pour construire %s. <br>Vos ressources sont : %s %s , %s %s and %s %s. <br>Le coût de'
    . ' construction est de : %s %s , %s %s and %s %s.';
...
$LNG['rs_ress_bonus_position'] = 'Bonus (à travers la position de la planète)';
...
$LNG['mg_delete_unmarked'] = 'Supprimer les messages non marqués de ce type';
...
$LNG['al_newname_specialchar'] = 'L\'alliance et le TAG doivent être écrits avec des caractères alphanumériques,'
    . ' mot, _, -,.!';
...
$LNG['al_request_deleted'] = 'Vous avez supprimer la candidature. <br> Vous pouvez créer vôtre Alliance ou en joindre'
    . ' une autre.';
...
$LNG['al_diplo_exists'] = 'Il existe déjà une relation diplomatique accepté valide (ou pas encore validée) avec'
    . ' l\'Alliance "%s"!';
...
$LNG['al_invalid_rank_name'] = 'Le noms de rank ne peut seulement contenir des nombres, des lettres, des espaces,'
    . ' ou _, -.!';
...
$LNG['op_admin_discord_id'] = 'Identifiant Discord propre pour le ping pour les MP';
$LNG['op_admin_discord_hook'] = 'Webhook Discord pour les messages PM';
...
$LNG['op_deactivate_ipcheck_descrip'] = 'Vérifier l\'IP signifie que la déconnexion de sécurité se produit'
    . ' automatiquement lorsque l\'IP change ou que deux personnes sont connectés sur un compte à partir de différentes'
...
$LNG['cff_mission_target_stay'] = 'Une flotte amical %s du joueur %s de %s %s %s est en orbite sur %s %s %s.'
    . ' Mission: %s';
...
$LNG['ma_no_range'] = 'La cible est hors de portée de tes missiles.';
...
$LNG['ti_create_info'] = '<p>S\'il vous plaît, lors de la création d\'un ticket de support, décrit et expliquer quel'
    . ' est votre problème avec le maximum de détails possible!</p><p>Une description détaillée de ce que vous voulez'
    . ' poser, raccourcit la durée du temps de la résolution et évite la perte de temps sur les deux côtés</p><p>Pour'
    . ' les questions liées aux comptes, spécifiez facilite l\'affectation de problème et réduit également le'
    . ' temps.</p>';
...
$LNG['kontakt'] =                   'Salut!<br>'
                                    ...
                                    .'<br>'
                                    .'Bien entendu, nous te répondrons également sur les post-its en jeu.<br>'
                                    .'Bedenke jedoch, dass auch wir das Spiel nur als Hobby betreiben. Les réponses peuvent prendre quelques jours.<br>';
...
//----------------------------------------------------------------------------//
$LNG['BlockTrade']  = 'Commerce en bloc';
$LNG['blockDm']    = 'Bloc PM';

//----------------------------------------------------------------------------//
$LNG['found'] = 'Trouvé ';
$LNG['expedition'] = 'Expédition';
$LNG['build'] = 'Construire';
$LNG['lost'] = 'Perdu';
$LNG['destroyed'] = 'Détruit';
$LNG['repaired'] = 'Réparation';
$LNG['other'] = 'Autres';
$LNG['advancedStats'] = 'Statistiques avancées';

$LNG['stats'] = [
    202 => 'Petit transporteurs',
    203 => 'Grand transporteurs',
    204 => 'Chasseur léger',
    205 => 'Chasseur lourd',
    206 => 'Croiseur',
    ...
    211 => 'Bombardier',
    212 => 'Satellites solaire',
    213 => 'Destructeur',
    214 => 'Étoile de la mort',
    215 => 'Traqueur',
    216 => 'Lune Noire',
    217 => 'Transporteurs ultime',
    218 => 'Avatar',
    219 => 'Recycleur ultime',

    400 => 'Systèmes de Défense',
    401 => 'Lanceur de missiles',
    402 => 'Canons laser léger',
    403 => 'Canons laser puissant',
    404 => 'Canons de Gauss',
    405 => 'Artillerie à Ions',
    406 => 'Lanceur de Plasma',
    407 => 'Petit Boucliers',
    408 => 'Grand Boucliers',
    409 => 'Dômes  de Protection',
    410 => 'Canons à Gravitons',
...
$LNG['Advanced_Stats'] = [
    ...
    'expo_count'                => 'Expéditions',
    'expo_black_hole'           => 'Trous noirs',
    'expo_pirates_small'        => 'Petits pirates',
    'expo_pirates_medium'       => 'Pirates moyens',
    'expo_pirates_large'        => 'Grands pirates',
    'expo_aliens_small'         => 'Petits extraterrestres',
    'expo_aliens_medium'        => 'Extraterrestres moyens',
    'expo_aliens_large'         => 'Les grands extraterrestres',
    'expo_res_small'            => 'Petites ressources trouvées',
    'expo_res_medium'           => 'Ressources moyennes trouvées',
    'expo_res_large'            => 'Grandes ressources trouvées',
    'expo_ships_small'          => 'Petits navires trouvés',
    'expo_ships_medium'         => 'Trouvailles de navires moyens',
    'expo_ships_large'          => 'Trouvailles de grands navires',
    'expo_slow'                 => 'Expéditions lentes',
    'expo_fast'                 => 'Expéditions rapides',
    'expo_nothing'              => 'Expéditions sans trouvailles',

    'moons_created'             => 'Lunes créées',
    'moons_destroyed'           => 'Lunes détruites',
    'moons_received'            => 'Lunes reçues',
    'first_moon_trys'           => 'Essais pour la première Lune',
    'destroy_moon_rips_lost'    => 'Les étoiles de la mort perdues tentent de détruire des lunes',
    'set_sail_wins'             => 'A gagné des combats avec le thème SetSails actif',
