	...
	<td class="left">
		...
		<table class="req">
			<tr>
				...
				<td class="transparent"><input type="text" name="host" value="{$getRequest.host|escape:'htmlall'|default:$host}" size="30"></td>
			</tr>
			<tr>
				<td class="transparent left"><p>{$LNG.step1_mysql_port}</p></td>
				<td class="transparent"><input type="text" name="port" value="{$getRequest.port|escape:'htmlall'|default:'3306'}" size="30"></td>
			</tr>
			<tr>
				<td class="transparent left"><p>{$LNG.step1_mysql_dbuser}</p></td>
				<td class="transparent"><input type="text" name="user" value="{$getRequest.user|escape:'htmlall'|default:$user}" size="30"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="transparent"><input type="text" name="dbname" value="{$getRequest.dbname|escape:'htmlall'|default:$dbname}" size="30"></td>
			</tr>
			<tr>
				<td class="transparent left"><p>{$LNG.step1_mysql_prefix}</p></td>
				<td class="transparent"><input type="text" name="prefix" value="{$getRequest.prefix|escape:'htmlall'|default:'uni1_'}" size="30"></td>
			</tr>
			<tr class="noborder">
