...
<tr>
	<td>{$LNG.pl_totalfight}</td><td>{$statisticData.totalfight|number_format}</td>
</tr>
<tr>
	<td>{$LNG.pl_fightwon}</td><td>{$statisticData.fightwon|number_format}{if $statisticData.totalfight} ({round($statisticData.fightwon / $statisticData.totalfight * 100, 2)}%){/if}</td>
</tr>
<tr>	
	<td>{$LNG.pl_fightlose}</td><td>{$statisticData.fightlose|number_format}{if $statisticData.totalfight} ({round($statisticData.fightlose / $statisticData.totalfight * 100, 2)}%){/if}</td>
</tr>
<tr>	
	<td>{$LNG.pl_fightdraw}</td><td>{$statisticData.fightdraw|number_format}{if $statisticData.totalfight} ({round($statisticData.fightdraw / $statisticData.totalfight * 100, 2)}%){/if}</td>
</tr>
<tr>
