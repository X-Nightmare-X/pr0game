...
<table id="tradeList" style="width:80%;white-space: nowrap;" class="tablesorter">
	...
	{if $FlyingFleetRow.possible_to_buy != true} trade-disallowed {/if}'>
		...
		<td class="resource_metal">{$FlyingFleetRow.fleet_resource_metal|number_format}</td>
		<td class="resource_crystal">{$FlyingFleetRow.fleet_resource_crystal|number_format}</td>
		<td class="resource_deuterium">{$FlyingFleetRow.fleet_resource_deuterium|number_format}</td>
		...
		<td class="wanted-resource-amount">{$FlyingFleetRow.fleet_wanted_resource_amount|number_format}</td>
