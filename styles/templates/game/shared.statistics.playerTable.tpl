...
<tr>
	...
	<td><a href="#" onclick="return Dialog.Playercard({$RangeInfo.id}, '{$RangeInfo.name}');"{if $RangeInfo.id == $CUser_id} style="color:lime"{/if}><span class="{if $RangeInfo.isBuddy} galaxy-friend{/if}">{$RangeInfo.name}&nbsp;</span></a>
