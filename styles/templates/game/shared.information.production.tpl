		...
		<tr>
			<td colspan="2">
				...
				<tr>
					...
					<td><span style="color:{if $production > 0}lime{elseif $production < 0}red{else}white{/if}">{number_format($production, 0, ",", ".")}</span></td>
					<td><span style="color:{if $productionDiff > 0}lime{elseif $productionDiff < 0}red{else}white{/if}">{number_format($productionDiff, 0, ",", ".")}</span></td>
					{/foreach}
				</tr>
				{/foreach}
				</table>
