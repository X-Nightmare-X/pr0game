...
<tr>
	...
	<td><a href="admin.php?page=cronjob&amp;action=enable&amp;id={$CronjobInfo.id}&amp;enable={if $CronjobInfo.isActive}0" class="colorPositive">{$LNG.cronjob_inactive}{else}1" class="colorNegative">{$LNG.cronjob_active}{/if}</a></td>
	<td><a href="admin.php?page=cronjob&amp;id={$CronjobInfo.id}&amp;action={if $CronjobInfo.lock}unlock" class="colorNegative">{$LNG.cronjob_is_lock}{else}lock" class="colorPositive">{$LNG.cronjob_is_unlock}{/if}</a></td>
