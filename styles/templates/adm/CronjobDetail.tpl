...
<tr>
	...
	<input name="min_all" id="min_all" type="checkbox" value="1" {if !empty($min) && $min.0==="*"}checked{/if}><label for="min_all">{$LNG.cronjob_selectall}</label></td>
</tr>
<tr>
	...
	<input name="hours_all" id="hours_all" type="checkbox" value="1" {if !empty($hours) && $hours.0==="*"}checked{/if}><label for="hours_all">{$LNG.cronjob_selectall}</label></td>
</tr>
<tr>
	...
	<input name="dom_all" id="dom_all" type="checkbox" value="1" {if !empty($dom) && $dom.0==="*"}checked{/if}><label for="dom_all">{$LNG.cronjob_selectall}</label></td>
</tr>
<tr>
	...
	<input name="month_all" id="month_all" type="checkbox" value="1" {if !empty($month) && $month.0==="*"}checked{/if}><label for="month_all">{$LNG.cronjob_selectall}</label></td>
</tr>
<tr>
	...
	<input name="dow_all" id="dow_all" type="checkbox" value="1" {if !empty($dow) && $dow.0==="*"}checked{/if}><label for="dow_all">{$LNG.cronjob_selectall}</label></td>
</tr>
<tr>
