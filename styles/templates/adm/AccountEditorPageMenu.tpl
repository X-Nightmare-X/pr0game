...
<tr>
   	...
   	<td width="50%"><a href="?page=accounteditor&amp;edit=personal"><img src="./styles/resource/images/admin/arrowright.png" width="16" height="10"> {$LNG.ad_editor_personal}</a></td>
