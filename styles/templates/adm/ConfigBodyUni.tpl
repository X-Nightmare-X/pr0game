...
<form action="" method="post">
	...
	<table width="70%" cellpadding="2" cellspacing="2">
		...
		<tr>
			<th colspan="2">{$se_galaxy_parameters}</th>
			<th>&nbsp;</th>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><img src="./styles/resource/images/admin/i.gif" width="16" height="16" alt="" class="tooltip" data-tooltip-content="{$se_uni_type_info}"></td>
		</tr>
		<tr>
			<td>{$se_galaxy_type}</td>
		...
		<tr>
			<th colspan="2">{$se_trader_head}</th>
			<th>&nbsp;</th>
		</tr>
		<tr>
